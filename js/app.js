...
const i18n = {
    fr: {
        choice_text2: "Évident, mais pas commode : implanter une station essence en zone inflammable, mitoyenne d'une oliveraie, n'allait pas de soi. Ce sont précisément ces contraintes qui ont donné au projet ses lignes directrices — et qui l'ont rendu réalisable.",
        ...
        about_p1: "Passionné d'architecture d'intérieur depuis toujours, j'ai étudié trois ans chez MJM Graphic Design Toulouse. Mon approche associe l'esquisse traditionnelle au rendu 3D, pour concevoir des espaces qui racontent une histoire.",
        about_p2: "Le détail, la lumière, les matériaux nobles et l'architecture vernaculaire guident chacun de mes projets. Chaque projet est une exploration entre fonctionnalité, esthétique et histoire du lieu.",
        ...
        contact_intro: "Discutons de votre projet d'aménagement intérieur. Une proposition d'embauche, une question, ou simplement l'envie d'échanger — n'hésitez pas.",
        ...
        proj_desc: "Conception d'un complexe moto multifonctionnel, inspiré des motels américains et des stations-service des années 60-70. Le projet articule une station essence, un garage moto, un espace d'exposition, un bar-restaurant et un espace de pause autour d'une circulation et d'une signalétique travaillées. C'est un lieu de rencontre et de rassemblement, pour les passionnés comme pour ceux qui découvrent cet univers.",
        proj_annotation:          "→ MJM Graphic Design Toulouse — 2025",
        lede_zooning: "Une oliveraie en bord de route, à Lambesc, sur un axe très fréquenté par les motards. Le projet s'installe sur une portion de parcelle restée vide : la circulation reprend les codes d'une piste de moto, et c'est elle qui commande l'implantation des bâtiments.",
        lede_plans: "Plans définitifs et détails, niveau par niveau, en épousant la verticalité du terrain. La matériauthèque répond à l'architecture vernaculaire du lieu : chaque matériau y est choisi pour tenir l'ensemble, du sol à la toiture.",
        lede_coupes: "Tout le travail porte ici sur la verticalité du site. Les coupes sont texturées pour donner à lire l'épaisseur du projet et la matière réelle des parois — ce qu'un plan seul ne montre jamais.",
        lede_3d: "La forme finale du projet. Ces vues, intérieures comme extérieures, montrent ce que j'avais en tête dès le premier croquis.",
        choice_eyebrow: "Les problématiques",
        choice_title: "Un site pas comme les autres",
        choice_text: "Le terrain n'a pas été choisi pour sa facilité. Perché dans les hauteurs de Lambesc, en pleine garrigue, au croisement de deux grands axes motards et à deux pas des routes de cols — loin de toute station-service et de tout point d'attraction. Je l'ai trouvé au détour d'une balade, et il s'est imposé.",
    ...
    en: {
        choice_text2: "Obvious, but not convenient: putting a filling station in a fire-prone area, right beside an olive grove, was never a given. Those very constraints gave the project its guiding lines — and made it buildable.",
        tools_zooning: "InDesign · Procreate",
        tools_plans: "ArchiCAD · Photoshop",
        tools_coupes: "ArchiCAD · Photoshop",
        tools_3d: "Twinmotion",
        ...
        about_p1: "I have been drawn to interior architecture for as long as I can remember. After three years at MJM Graphic Design Toulouse, my approach pairs traditional sketching with 3D rendering, to design spaces that tell a story.",
        about_p2: "Detail, light, honest materials and vernacular architecture guide every project I take on. Each one is an exploration between function, aesthetics and the story of the place.",
        ...
        proj_desc: "A multi-purpose motorcycle complex, drawn from American motels and 1960s-70s filling stations. It brings together a filling station, a motorcycle garage, an exhibition space, a bar-restaurant and a rest area around carefully designed circulation and wayfinding. A place to meet and gather, for enthusiasts and newcomers alike.",
        proj_annotation:          "→ MJM Graphic Design Toulouse — 2025",
        lede_zooning: "An olive grove by the roadside in Lambesc, on a route heavily travelled by motorcyclists. The project settles on an empty stretch of the plot: circulation borrows the language of a racetrack, and it is what dictates where the buildings stand.",
        ...
        lede_coupes: "Everything here is about the verticality of the site. The sections are textured to convey the depth of the project and the real substance of its walls — what a plan alone never shows.",
        lede_3d: "The final form of the project. These views, inside and out, show what I had in mind from the very first sketch.",
        choice_eyebrow: "The challenges",
        choice_title: "A site unlike any other",
        choice_text: "The site was not chosen for being easy. Perched above Lambesc in open garrigue, at the crossing of two major motorcycle routes and a stone's throw from the mountain passes — far from any filling station or point of interest. I came across it on a ride, and it imposed itself.",
