 ...
 * Rectangle SVG dessin� main + Menu habill� + Carrousel inertie
 */
...
const i18n = {
    fr: {
        meta_title:          "Even ANICET � Architecte d'int�rieur",
        meta_desc:           "Portfolio d'Even ANICET, architecte d'int�rieur dipl�m� de MJM Graphic Design Toulouse.",
        home_subtitle:       "Architecte d'int�rieur",
        home_scroll:         "D�filez",
        menu_01: "ACCUEIL",  menu_02: "PROJETS", menu_03: "DESSINS",
        menu_04: "DIPL�ME",  menu_05: "HOBBIES", menu_06: "CONTACT",
        menu_deco_01: "bienvenue",
        menu_deco_02: "mes r�alisations",
        menu_deco_03: "� main lev�e",
        menu_deco_04: "MJM Toulouse",
        menu_deco_05: "moto & perso",
        menu_deco_06: "parlons-en",
        nav_next:            "suivant",
        proj_01_title:       "PROJET 01 : DIPL�ME",
        proj_02_title:       "PROJET 02 : PATER SUISSE",
        proj_03_title:       "PROJET 03 : � SUIVRE...",
        proj_loading:        "en cours...",
        copied:              "copi� !",
        video_placeholder:   "une vid�o arrive !",
        ...
        about_p1:            "Passionn� d'architecture d'int�rieur depuis toujours, je suis �tudiant en derni�re ann�e � MJM Graphic Design Toulouse. Mon approche allie l'esquisse traditionnelle au rendu 3D num�rique pour cr�er des espaces qui racontent une histoire.",
        about_p2:            "Je m'int�resse particuli�rement aux volumes bruts, aux mat�riaux nobles et � la lumi�re naturelle. Chaque projet est une exploration entre fonctionnalit� et esth�tique.",
        about_annotation:    "? toujours en qu�te du d�tail juste",
        projects_intro:      "Conception d'espaces minimalistes et mod�lisations techniques 3D.",
        proj_cat_3d:         "Rendu 3D & Int�rieur",
        proj_cat_plan:       "Plan & Am�nagement",
        proj_cat_sketch:     "Esquisse & Concept",
        photos_intro:        "D�tails de textures, mati�res et jeux d'ombres.",
        drawings_intro:      "Esquisses architecturales � main lev�e sur papier A4.",
        study_degree:        "Dipl�me d'Architecte d'Int�rieur",
        study_focus:         "Sp�cialisations",
        study_focus_desc:    "Mod�lisation 3D, plans de coupe, design mobilier et gestion d'espace.",
        study_address:       "Adresse",
        study_school_status: "Statut de l'�tablissement",
        study_school_status_desc: "Enseignement sup�rieur priv� technique, enregistr� aupr�s de l'Acad�mie de Toulouse.",
        diploma_cert_title: "CERTIFICATION RNCP",
        diploma_cert_subtitle: "Designer en architecture d'int�rieur - Niveau 6",
        diploma_cert_rncp: "STATUT R�GLEMENTAIRE",
        diploma_cert_rncp_val: "Titre de niveau 6 (Bac+3 / Licence) inscrit au RNCP, certifiant l'aptitude � concevoir des espaces int�rieurs, �laborer des dossiers techniques et superviser des chantiers.",
        diploma_cert_credits: "CR�DENTIALS ACAD�MIQUES",
        diploma_cert_credits_val: "�quivalence de 180 cr�dits ECTS (Niveau 6 Europ�en EQF). �quivalence Suisse : Bachelor of Arts (BA) HES en architecture d'int�rieur. Formation �ligible au CPF.",
        diploma_cert_competences: "COMP�TENCES CL�S ACCR�DIT�ES",
        diploma_cert_c1: "Diagnostic technique, spatial et r�glementaire de l'existant.",
        diploma_cert_c2: "Cr�ation de concepts esth�tiques, plans de coupe et mod�lisations 3D.",
        diploma_cert_c3: "Prescription technique des mat�riaux, devis et cahiers des charges.",
        diploma_cert_c4: "Planification des interventions et coordination de la ma�trise d'�uvre.",
        diploma_cert_footer: "Enregistr� par France Comp�tences",
        diploma_scan_title: "Scan du dipl�me officiel",
        diploma_scan_placeholder_title: "Scan du dipl�me (A4 Paysage) � int�grer ici",
        diploma_scan_placeholder_sub: "Espace r�serv� pour le document officiel de fin de cycle (A4 Paysage)",
        contact_intro:       "Discutons de votre projet d'am�nagement int�rieur.",
        form_name: "NOM", form_email: "EMAIL",
        form_message: "MESSAGE", form_send: "ENVOYER",
        contact_direct:   "CONTACT DIRECT",
        contact_social:   "R�SEAUX",
        ...
        drawing_title_style: "� LA MANI�RE DE...",
        drawing_desc_style:  "�tude de style & Graphite � A4",
        bd_title:            "BANDE DESSIN�E",
        legal_copyright:  "Toutes les �uvres pr�sent�es sur ce site (rendus 3D, esquisses, photographies, dessins) sont la propri�t� exclusive d'Even ANICET. Toute reproduction, distribution ou utilisation sans autorisation �crite pr�alable est strictement interdite.",
        legal_cert:       "Je certifie �tre l'auteur de l'ensemble des travaux et productions pr�sent�s sur ce portfolio. Les images et cr�ations sont prot�g�es par le droit d'auteur conform�ment au Code de la Propri�t� Intellectuelle fran�ais (articles L.111-1 et suivants).",
        legal_mentions:   "Mentions l�gales",
        legal_rights:     "Tous droits r�serv�s",
        // Page Projets
        proj_title:               "PROJET 01 : DIPL�ME",
        proj_desc:                "Conception d�un complexe automobile multifonctionnel inspir� des motels am�ricains des ann�es 60-70. Le projet articule une station essence, un garage moto, un espace d�exposition, un bar/restaurant et un espace de pause autour d�une circulation fluide et d�une toiture servant de signal�tique.",
    ...
    en: {
        ...
        proj_02_title:       "PROJECT 02: PATER SUISSE",
        ...
        diploma_cert_footer: "Registered by France Comp�tences",
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // R�v�ler la page home avec animation d'entr�e
    showPage('home', false);

    // Animations au scroll pour les appareils tactiles (mobile)
    // Appel� APR�S showPage pour que is-active soit bien pr�sent
    initScrollAnimationsMobile();

    // Animation d'entr�e du hero � d�cal�e pour laisser la page se monter
...
function initMenu() {
        ...
        item.addEventListener('click', e => {
            ...
            if (page === 'contact') {
                ...
                setTimeout(() => {
                    ...
                    // FIX: utiliser lenis.scrollTo au lieu de homeEl.scrollTo pour �viter le conflit
    ...
    // Clic sur l'arri�re-plan du menu (partie grise) pour revenir en arri�re
...
function openMenu() {
    ...
    // BUG-12 FIX : mettre � jour aria-hidden pour les screen readers
    const menuOverlay = document.getElementById('menu-overlay');
    if (menuOverlay) menuOverlay.setAttribute('aria-hidden', 'false');

    // Animation d'entr�e des items avec d�calage vertical
...
function showPage(pageId, animate = true) {
    ...
    // D�truire le Lenis de l'ancienne page
...
// Quand on revient sur la page home, remettre le hero logo en �tat initial
...
// -------------------------------------
// LOGO BANDEAU � APPARA�T AU SCROLL SUR HOME
// -------------------------------------
...
function initPageLenis(scrollContainer) {
    ...
    const lenisOptions = {
        ...
        duration: 1.0,                  // FIX: r�duit de 1.15 ? 1.0 pour un scroll plus r�actif
    ...
    // BUG-04 FIX : stocker la r�f�rence du ticker pour pouvoir le supprimer plus tard
    // et �viter l'accumulation de tickers � chaque navigation entre pages.
    ...
    if (currentPage === 'home') {
        ...
        lenis.on('scroll', ({ scroll }) => {
            ...
            if (scroll > threshold && !logoInHeader) {
                ...
                // Hero logo dispara�t vers le haut
...
function generateLines(container) {
    ...
    for (let i = 0; i < numLines; i++) {
        ...
        // Longueurs al�atoires : d�but et fin varient
...
function initContactAnimation() {
    ...
    form.addEventListener('submit', (e) => {
        ...
        // Validation basique pour autoriser les emails �tranges (ex: sans .com)
...
function initBDCarousel() {
    ...
    containers.forEach(container => {
        ...
        function updateCarousel(index) {
            ...
            // LAZY PDF : rendre le PDF du slide qui devient actif s'il n'est pas encore charg�
            ...
            if (activeSlide) {
                ...
                // Pr�-charger aussi le slide suivant (sans attendre)
...
// -------------------------------------
// RENDU PDF INLINE � LAZY + OPTIMIS�
// Charge seulement le slide visible en premier, puis les autres en diff�r�
// -------------------------------------
let _pdfLib = null;
let _pdfCache = {}; // Cache des documents PDF d�j� charg�s

async function getPdfLib() {
    if (_pdfLib) return _pdfLib;
    if (typeof pdfjsLib !== 'undefined') _pdfLib = pdfjsLib;
    else if (window.pdfjsLib) _pdfLib = window.pdfjsLib;
    if (!_pdfLib) { console.error('PDF.js non charg�.'); return null; }
    // Toujours utiliser le worker CDN correspondant � la m�me version que pdf.min.js
...
async function renderSingleCanvas(canvas) {
    ...
    try {
        // Utiliser le cache pour �viter de re-t�l�charger le m�me fichier
        if (!_pdfCache[url]) {
            // Charger le PDF directement via URL (streaming, compatible mobile)
        // encodeURI pour g�rer les espaces et caract�res sp�ciaux dans les noms de fichiers
        _pdfCache[url] = await pdfLib.getDocument(encodeURI(url)).promise;
        }
        const pdf = _pdfCache[url];
        const page = await pdf.getPage(1);

        // �chelle r�duite pour les miniatures du carrousel (performance)
        ...
        canvas.parentElement.classList.remove('pdf-shimmer');
        canvas.classList.remove('pdf-loading');
        // Afficher un placeholder �l�gant en cas d'erreur
...
async function renderInlinePDFs() {
    ...
    // PRIORIT� 1 : Rendre d'abord les slides actifs/visibles
    ...
    // Rendre les visibles en premier (en parall�le limit�e)
    await Promise.allSettled(visibleCanvases.map(c => renderSingleCanvas(c)));

    // Rafra�chir Lenis apr�s le premier batch
    if (window._lenis) window._lenis.resize();
    if (typeof ScrollTrigger !== 'undefined') ScrollTrigger.refresh();

    // Rendre les non-visibles en diff�r� (avec d�lais entre chaque pour ne pas bloquer le thread)
...
const allDrawings = [
    ...
    },
    {
        ...
        title: "� LA MANI�RE DE...",
        desc: "�tude de style & Graphite � A4",
        orient: "landscape"
    },
    {
    ...
    },
    {
        ...
        title: "BANDE DESSIN�E � Page 1",
        desc: "A4 � Portrait",
        orient: "portrait"
    },
    {
        url: "dessin/BD page 2-1.png",
        title: "BANDE DESSIN�E � Page 2",
        desc: "A4 � Portrait",
        orient: "portrait"
    },
    {
        url: "dessin/BD page 3-1.png",
        title: "BANDE DESSIN�E � Page 3",
        desc: "A4 � Portrait",
        orient: "portrait"
    },
    {
        url: "dessin/BD page 4-1.png",
        title: "BANDE DESSIN�E � Page 4",
        desc: "A4 � Portrait",
        orient: "portrait"
    }
];
...
const diplomeCoupes = [
    ...
    { url: 'PDF/coupe nord textur�.pdf', title: 'Coupe Nord' },
    { url: 'PDF/coupe ouest textur�.pdf', title: 'Coupe Ouest' },
    { url: 'PDF/coupe sud textur�.pdf', title: 'Coupe Sud' }
];

const diplomeAnalyses = [
    { url: 'PDF/plan masse.pdf', title: 'Plan Masse' },
    { url: 'PDF/trame.pdf', title: 'Trame' },
    { url: 'PDF/zooning batiment.pdf', title: 'Zoning B�timent' },
...
// -------------------------------------
// LIGHTBOX ULTRA-�PUR�E (STYLE FORTICHE)
// -------------------------------------
function initDrawingLightbox() {
    ...
    // -- API globale pour ouvrir avec une galerie sp�cifique --
    ...
    // -- Clic sur le scan du dipl�me (Mode image unique) --
    ...
    if (zoomRange) {
        zoomRange.addEventListener('input', (e) => {
            ...
            if (scale > 1 && !isZoomed) {
                ...
                translateX = 0;
                translateY = 0;
                // On ne retire pas la classe .zoomed ici pour �viter que 
                // la barre ne disparaisse sous le clic de l'utilisateur, ce qui 
                // d�clencherait un clic sur le fond et fermerait la fen�tre.
            }
            updateTransform();
        });

        // L'�v�nement 'change' se d�clenche quand on rel�che le clic sur la barre
    ...
    // Clic en dehors de l'image = fermer, clic sur l'image = zoom (si non zoom�)
...
function initScrollAnimationsMobile() {
    ...
    // S�lecteurs � observer � m�me liste que les �l�ments anim�s en CSS
    const SELECTORS = [
        '.drawing-item',
        '.project-item',
        '.hc-item',
    ...
    // BUG ANDROID FIX : Le scroll se fait � l'int�rieur des �l�ments .page
    // (overflow-y: auto), pas dans le viewport du navigateur.
    // Il faut donc cr�er un IntersectionObserver PAR PAGE avec root = la page,
    // sinon le navigateur consid�re que tout est "dans le viewport" car .page
    // couvre tout l'�cran en position: absolute.
    ...
    // Observer tous les �l�ments d'une page donn�e
    ...
    // Lancement initial sur la page home (d�j� active au moment de l'appel)
    const homePage = document.getElementById('page-home');
    if (homePage) {
        // L�ger d�lai pour s'assurer que showPage() a bien ajout� is-active
        // et que le layout est statis�
        setTimeout(() => observeInPage(homePage), 300);
    }

    // Pour chaque autre page : observer d�s qu'elle devient active (navigation SPA)
    document.querySelectorAll('.page').forEach(page => {
        if (page.id === 'page-home') return; // d�j� g�r� ci-dessus

        const mutObserver = new MutationObserver(() => {
            if (page.classList.contains('is-active')) {
                // D�lai pour laisser la transition de page se terminer
