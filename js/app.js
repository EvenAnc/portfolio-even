...
const i18n = {
    fr: {
        ...
        pf_l_lieu:       "Lieu",
        pf_v_lieu:       "Ville, pays",
        pf_l_annee:      "Étude",
        pf_v_annee:      "2025",
        pf_l_surface:    "Surface",
        pf_v_surface:    "000 m²",
        pf_l_programme:  "Programme",
        pf_v_programme:  "Station, garage, exposition, restaurant",
        pf_l_cadre:      "Cadre",
        pf_v_cadre:      "Projet de diplôme — MJM Toulouse",
        lede_zooning:    "À remplir — deux phrases : où se trouve le site, ce qui a été demandé, et la contrainte qui a orienté tout le reste.",
        lede_plans:      "À remplir — deux phrases : comment le programme se répartit sur les niveaux, et le principe de circulation qui les relie.",
        lede_coupes:     "À remplir — deux phrases : ce que les coupes règlent que les plans ne montrent pas — hauteurs, lumière, rapport au terrain.",
        lede_3d:         "À remplir — deux phrases : ce que l'on ressent une fois dedans, matières et lumière à l'appui.",
        choice_eyebrow:  "L'arbitrage",
        choice_title:    "À remplir — le choix en une phrase",
        choice_text:     "À remplir — quatre à six phrases. Quel problème se posait, quelles options s'offraient, laquelle a été retenue et pourquoi, ce qu'elle a coûté. C'est le passage qu'un recruteur lit en entier : il n'y voit pas un rendu, il y voit une façon de raisonner.",
    ...
    en: {
        ...
        proj_annotation:          "→ MJM Graphic Design Toulouse — 2025",
        pf_l_lieu:       "Location",
        pf_v_lieu:       "City, country",
        pf_l_annee:      "Year",
        pf_v_annee:      "2025",
        pf_l_surface:    "Floor area",
        pf_v_surface:    "000 m²",
        pf_l_programme:  "Programme",
        pf_v_programme:  "Filling station, garage, exhibition, restaurant",
        pf_l_cadre:      "Context",
        pf_v_cadre:      "Graduation project — MJM Toulouse",
        lede_zooning:    "To be written — two sentences: where the site is, what was asked for, and the constraint that shaped everything else.",
        lede_plans:      "To be written — two sentences: how the programme is spread across the levels, and the circulation principle that links them.",
        lede_coupes:     "To be written — two sentences: what the sections settle that the plans cannot show — heights, daylight, relation to the ground.",
        lede_3d:         "To be written — two sentences: what it feels like once inside, materials and light to back it up.",
        choice_eyebrow:  "The call",
        choice_title:    "To be written — the decision in one sentence",
        choice_text:     "To be written — four to six sentences. What problem came up, what the options were, which one was taken and why, what it cost. This is the passage a recruiter reads in full: they are not looking at a rendering, they are looking at a way of thinking.",
