...
const i18n = {
    fr: {
        ...
        about_p2: "Ce qui me retient, c'est le détail, la lumière, les matériaux nobles. Et l'architecture vernaculaire, qui guide tous mes projets : je regarde comment on bâtissait sur place, avec ce qu'on avait sous la main. Chaque projet est une recherche entre la fonction, l'esthétique et l'histoire du lieu.",
    ...
    en: {
        ...
        about_p2: "What holds my attention is detail, light, honest materials. And vernacular architecture, which guides all my projects: I look at how people built on site, with whatever they had to hand. Every project is a search between function, aesthetics and the story of the place.",
